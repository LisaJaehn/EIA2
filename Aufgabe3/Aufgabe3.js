...
(function (Memorie) {
    ...
    function createCards() {
        ...
        let _numPairs = fieldSize * fieldSize / 2;
        ...
        for (var i = 0; i < _numPairs; i++) {
            let contentIsTaken = true;
            // Random Buchstabe generieren.
            let letterIndex = getRandomAvailableContent();
            let letter = cardContent[letterIndex];
    ...
    Memorie.createCards = createCards;
