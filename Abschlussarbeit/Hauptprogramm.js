...
(function (Abschlussarbeit) {
    ...
    //Äpfel
    function drawApples(_x, _y, _radius) {
        crc2.beginPath();
    ...
    //Orangen
    function drawOranges(_x, _y, _radius) {
        crc2.beginPath();
    ...
    function drawBush1(_x, _y, _radius) {
        crc2.beginPath();
    ...
    function drawBush3(_x, _y, _radius) {
        crc2.beginPath();
    ...
    function drawBush2(_x, _y, _radius) {
        crc2.beginPath();
        crc2.fillStyle = "rgb(188,238,104)";
        crc2.arc(_x, _y, _radius, 0, 2 * Math.PI);
        crc2.closePath();
    ...
    function drawBush4(_x, _y, _radius) {
        crc2.beginPath();
        crc2.fillStyle = "rgb(0,139,0)";
        crc2.arc(_x, _y, _radius, 0, 2 * Math.PI);
        crc2.closePath();
